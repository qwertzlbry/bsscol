...
\NormalTok{bss\_colors \textless{}{-}}\StringTok{ }\NormalTok{bss\_colors }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{arrange}\NormalTok{(col\_pal) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(}\OperatorTok{{-}}\NormalTok{colour)}
\NormalTok{bss\_dt \textless{}{-}}\StringTok{ }\NormalTok{bss\_colors}
\NormalTok{bss\_dt}\OperatorTok{$}\NormalTok{hashed\_hex =}\StringTok{ }\KeywordTok{cell\_spec}\NormalTok{(}
\NormalTok{  bss\_dt}\OperatorTok{$}\NormalTok{hashed\_hex, }\DataTypeTok{color =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{align =} \StringTok{"c"}\NormalTok{, }\CommentTok{\#angle = 2,}
  \DataTypeTok{background =} \KeywordTok{factor}\NormalTok{(bss\_dt}\OperatorTok{$}\NormalTok{excel\_form,bss\_dt}\OperatorTok{$}\NormalTok{excel\_form, bss\_dt}\OperatorTok{$}\NormalTok{hashed\_hex))}

\KeywordTok{kbl}\NormalTok{(bss\_dt, }\DataTypeTok{escape =}\NormalTok{ F) }\OperatorTok{\%\textgreater{}\%}
\StringTok{  }\KeywordTok{kable\_paper}\NormalTok{(}\StringTok{"striped"}\NormalTok{, }\DataTypeTok{full\_width =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bss\_colors \textless{}{-}}\StringTok{ }\NormalTok{bss\_colors[}\KeywordTok{order}\NormalTok{(bss\_colors}\OperatorTok{$}\NormalTok{col\_pal),]}

\KeywordTok{swatch}\NormalTok{(bss\_colors}\OperatorTok{$}\NormalTok{hashed\_hex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{choice \textless{}{-}}\StringTok{ }\NormalTok{bss\_colors }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(col\_pal }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{)}
\KeywordTok{swatch}\NormalTok{(choice}\OperatorTok{$}\NormalTok{hashed\_hex)}
\end{Highlighting}
\end{Shaded}
